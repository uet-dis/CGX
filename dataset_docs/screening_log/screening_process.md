# PRISMA Screening Log - Heart Failure Final Set

A rigorous screening process combining automated queries and manual selection to identify the 50 most relevant clinical documents for the **CGX** framework.

## 1. Screening Process (Flow Diagram Data)

| Phase | Description | Quantity (n) |
| :--- | :--- | :--- |
| **Identification** | Initial broad PubMed Central (PMC) query results | 32,415 |
| **Screening** | Time-limited (2020-2025) and publication type (Guidelines) | 17,450 |
| **Screening** | Filtered by Elite Cardiology Journals | 2,815 |
| **Eligibility** | Refined Title search (Heart Failure + Management/Guidelines) | **214** |
